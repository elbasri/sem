...
<table>
<tr><td><?php echo $this->Form->input('ref',array('label' => 'Numéro d\'inventaire')); ?></td> <td><?php echo $this->Form->input('nom',array('label' => 'Désignation')); ?></td></tr>
...
<tr><td><?php echo $this->Form->input('fournisseur_id', array('label'=>'Fournisseur','options' => $optionsfo,'style'=>'width: 100%')); ?></td><td><?php echo $this->Form->input('conditionnement',array('label' => 'Conditionnement')); ?></td></tr>
