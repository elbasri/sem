...
<?php } ?> 
		...
		<td style="text-align:left;">Recherche par nom (titre) de spécialité</td>
		</tr>
		...
		<td style="text-align:left;">Recherche par Numéro de spécialité</td>
		</tr>
...
<?php } ?> 
	...
	<td><?php 
	echo $this->HTML->link('Modifier',array('controller'=>'Specialites','action'=>'modifier',$post['Specialite']['id'])).' '.$this->Form->postLink('Supprimer',array('controller'=>'Specialites','action'=>'supprimer',$post['Specialite']['id']));?></td>
	</tr>
