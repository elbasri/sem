...
<?php echo $this->Form->input('Invoice.number', array('value' => 5, 'label' => 'Invoice Number')); ?>
...
<?php echo $this->Form->input('Invoice.due_date', array('value' => "2014-02-02", 'type' => 'datepicker')); ?>
<table>
...
<?php echo $this->Form->input('InvoiceItem.0.name', array('empty' => '-- Select --', 'options' => array('zzz'=>'zzz','zzz'=>'zzz'), 'div' => false, 'label' => false, 'class' => 'combobox')); ?>
</td>
<!-- <div class="row">
<div class="col-xs-9">
</div>
...
<?php echo $this->Form->input('Invoice.introduction', array('value' => '45', 'label' => 'Notes to client')); ?>
<?php echo $this->Form->input('Invoice.conclusion', array('value' => '45', 'label' => 'Terms')); ?>
