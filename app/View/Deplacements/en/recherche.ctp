...
<?php } ?>
		<?php echo $this->Form->create('Deplacement',array('action'=>'recherche'));?>
		<table style="width:100%">
		<tr>
		<td><input name="rechercher" value="2" required="" type="radio"></td>
		<td style="text-align:left;">Recherche par Date de déplacement</td>
		</tr>
		...
		<td style="text-align:left;">Recherche par Reference de déplacement</td>
		</tr>
		...
		<td style="text-align:left;">Recherche par ID de déplacement</td>
		</tr>
...
<div class="affichage" style="float:right;width:80%"> 
<?php } ?>
	<h1>Resultat de recherche dans les déplacements :</h1>
	<table >
	<tr>
	<th>ID</th>
	<th>Reference</th>
