...
?>
	...
	<div class="infosdemande" >
			<table >
				<tr >
					<td style="width:35%">ID: <strong><?php echo $post['Materiel']['id'];?></strong>
					</td>
 ...
 <br><h2>DONNÉES DE BASE</h2>	
			<table >
				<tr >
					<td style="width:35%">Reference: <strong><?php echo $post['Materiel']['ref'];?></strong>
					</td>
				...
				<tr>
					...
					<td style="width:35%">Durée de conservation: <strong>
						<table>
							...
							<tr><td>Current Status</td><td><?php if(date('Y-m-d')>$post['Materiel']['datef']) echo "<font color='red'>Durée dépassé</font>"; else echo "<font color='green'>Conservé</font>";?></td></tr>
						</table>
					</td>
				</tr>
				<tr>
