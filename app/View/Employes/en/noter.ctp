...
<h1>Noter un Employe</h1>
		<div class="infosdemande" >
			<table style="width:100%">
				<tr>
					<td><?php echo $this->Html->image('images/nomdemande.png', array('alt' => 'Add un employe','title'=>'Add un employe')); ?>
					</td>
					<td><?php echo $this->Form->input('nom', array('label'=>'The employee','options' => $options));?>
					</td>
				</tr>
				<tr>
					<td>
