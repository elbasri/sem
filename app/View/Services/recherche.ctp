...
<?php } ?> 
	...
	<td>
	<?php 
	echo $this->HTML->link('Modifier',array('controller'=>'Services','action'=>'modifier',$user['Service']['id'])).' '.$this->Form->postLink('Supprimer',array('controller'=>'Services','action'=>'supprimer',$user['Service']['id']));
