...
<?php } ?>
		<?php echo $this->Form->create('Facture',array('action'=>'recherche'));?>
		...
		<td style="text-align:left;">Recherche par intitulé</td>
		</tr>
		...
		<td style="text-align:left;">Recherche par statut</td>
		</tr>
		
		<tr>
		<td></td><td></td>
		<td><?php echo $this->Form->input('et',array('label' => 'Statut','options'=>array('Réglée'=>'Réglée','Non réglée'=>'Non réglée'))); ?></td>
		</tr>
		
		<tr>
		<td><input name="rechercher" value="2" required="" type="radio"></td>
		<td style="text-align:left;">Recherche par Montant</td>
		</tr>
...
<div class="affichage" style="float:right;width:80%"> 
<?php } ?>
	<h1>Resultat de recherche dans les Factures :</h1>
	<table >
		<tr>
		<th>ID</th>
		<th>Reference</th>
