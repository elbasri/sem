...
/*if($this->Session->read('typecrm')=='f')
	...
	echo 'Modifier un fabricant';
else if($this->Session->read('typecrm')=='sm')
	echo 'Modifier une société de maintenance';
else if($this->Session->read('typecrm')=='sa')
	echo 'Modifier une société d\'assurance';
else if($this->Session->read('typecrm')=='sl')
	echo 'Modifier une société de location';
else
...
?>	</h1>		
			<table >	
				<tr >
					...
					<td><?php echo $this->Form->input('nom',array('id'=>'nom','placeholder'=>'service ou établissement','label'=>'Service ou établissement'));?>
					</td>
					
					<td><?php echo $this->Html->image('images/nomdemande.png', array('alt' => 'Le Prénom','title'=>''));?></td>
					<td><?php echo $this->Form->input('prenom',array('id'=>'prenom','placeholder'=>'Nom de contact','label'=>'Le responsable'));
					?>
					</td>
