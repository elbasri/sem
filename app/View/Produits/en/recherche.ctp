...
<?php } ?> 
	...
	<?php 
	echo $this->HTML->link('Edit',array('controller'=>'produits','action'=>'Edit',$user['Produit']['id'])).' '.$this->Form->postLink('Delete',array('controller'=>'produits','action'=>'Delete',$user['Produit']['id']));
