...
<?php } ?>
	<table>
	<tr>
	<th>ID</th><th>Titre</th><th>Etat</th><th>Date de création</th><th>Action</th>
	</tr>
	...
	<td>
	<?php 
	echo $this->HTML->link('Edit',array('controller'=>'Consultations','action'=>'edit',$user['Consultation']['id'])).' '.$this->Form->postLink('Delete',array('controller'=>'Consultations','action'=>'Delete',$user['Consultation']['id']));
