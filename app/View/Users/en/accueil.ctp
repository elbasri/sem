...
<h1>Les CIN expirés <a href="<?=$this->Html->url('/employes/cin')?>" ><font size="3">(La liste complète)</font></a></h1>
	<table>
		...
		<td>
		<?php echo $this->Html->link('Afficher The employee',array('controller'=>'employes','action'=>'view',$user['Employe']['id'],Inflector::slug($user['Employe']['nom'],$replacement ='_')));?>
		</td>
		</tr>
...
<h1>Les leave Dones <a href="<?=$this->Html->url('/vacances/t')?>" ><font size="3">(La liste complète)</font></a></h1>
	<table>
		<tr> 
		<th>Due of leave</th>
		<th>Type of leave</th>
