		...
		<div class="infosdemande" >
			...
			<table >	
				...
				<tr >
					...
					<td><strong><?php echo $this->Html->link('Cliquer ici pour modifier votre mot de passe',array('controller'=>'users','action'=>'passe',$this->request->data['User']['id'])); ?></strong>
					</td>
				...
				<tr>
					<td><?php echo $this->Html->image('images/secietedemande.png', array('alt' => 'Créer un compte sur votrecodeur.com','title'=>'Créer un compte sur votrecodeur.com'));?></td>
					<td><?php echo $this->Form->input('ville',array('id'=>'Ville','placeholder'=>'Numéro de Ville'));
					?>
					</td>
					<td><?php echo $this->Html->image('images/secietedemande.png', array('alt' => 'Créer un compte sur votrecodeur.com','title'=>'Créer un compte sur votrecodeur.com'));?></td>
