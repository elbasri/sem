		...
		<div class="infosdemande" >
			...
			<table >	
				...
				<tr >
					...
					<td><?php echo $this->Form->input('nom',array('id'=>'nom','placeholder'=>'Le Nom de The employee'));?>
					</td>
					
					<td><?php echo $this->Html->image('images/nomdemande.png', array('alt' => '','title'=>''));?></td>
					<td><?php echo $this->Form->input('prenom',array('id'=>'prenom','placeholder'=>'Le Prénom de The employee','label'=>'Le Prénom'));
					?>
					</td>
				...
				<tr >
					...
					<td><?php echo $this->Html->image('images/nomdemande.png', array('alt' => '','title'=>''));?></td>
					<td><?php echo $this->Form->input('datenaissance',array('id'=>'datenaissance','placeholder'=>'Date de Naissance de The employee','label'=>'Date de Naissance','minYear' => date('Y') - 70));
					?></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><?php echo $this->Html->image('images/emaildemande.png', array('alt' => '','title'=>''));?></td>
					<td><?php echo $this->Form->input('pays',array('id'=>'pays','placeholder'=>'Le Pays ou la Nationalité de The employee','label'=>'Le Pays/Nationalité'));
					?></td>
				...
				<tr>
					...
					<td><?php echo $this->Html->image('images/emaildemande.png', array('alt' => '','title'=>''));?></td>
					<td><?php echo $this->Form->input('adressepostale',array('id'=>'adressepostale','placeholder'=>'L\'adresse postale de The employee','label'=>'L\'adresse'));
					?>
					</td>
				</tr>
				<tr>
					<td><?php echo $this->Html->image('images/secietedemande.png', array('alt' => '','title'=>''));?></td>
					<td><?php echo $this->Form->input('datetravail',array('id'=>'datetravail','placeholder'=>'Start date du contrat','label'=>'Start date du contrat','minYear' => date('Y') - 70));
					?></td>
					<td><?php echo $this->Html->image('images/secietedemande.png', array('alt' => '','title'=>''));?></td>
					<td><?php echo $this->Form->input('datefintravail',array('id'=>'datefintravail','placeholder'=>'Date de End date du contrat','label'=>'Date de End date du contrat','minYear' => date('Y') - 70));
					?></td>
				</tr>
				<tr>
					<td><?php echo $this->Html->image('images/secietedemande.png', array('alt' => '','title'=>''));?></td>
					...
					<td><?php echo $this->Html->image('images/secietedemande.png', array('alt' => '','title'=>''));?></td>
					<td><?php echo $this->Form->input('salaire',array('id'=>'salaire','placeholder'=>'Le salaire de The employee','label'=>'Le salaire','value'=>'0'));
					?>
					</td>
				</tr>
				<tr>
					<td><?php echo $this->Html->image('icons/lock.png', array('alt' => '','title'=>'','width'=>'20'));?></td>
					<td><?php echo $this->Form->input('cnss', array('label'=>'N° de sécurité sociale','style'=>'width: 100%','value'=>'0'));
					?>
					</td>
					<td><?php echo $this->Html->image('icons/lock.png', array('alt' => '','title'=>'','width'=>'20'));?></td>
					<td><?php echo $this->Form->input('matricule',array('id'=>'salaire','label'=>'Matricule','value'=>'0'));?>
					</td>
				</tr>
			</table>								
		</div>	
...
<?php echo $this->Form->end('Déclarer The employee'); ?>
					</td>
				</tr>
	</table>	
</div>