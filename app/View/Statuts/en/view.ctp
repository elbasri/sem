...
?>
	...
	<div class="infosdemande" >
			...
			<table >
				<tr>
					<td style="width:35%">Reference: <strong><?php echo $post['Statut']['ref'];?></strong>
					</td>
					
					<td style="width:35%">Status actuel: <strong><?php echo $post['Statut']['nom'];?></strong>
					</td>
				</tr>
				<tr>
					<td style="width:35%">End date: <strong><?php echo $post['Statut']['date'];?></strong>
					</td>
