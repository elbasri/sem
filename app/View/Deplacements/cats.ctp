...
<?php foreach($options as $post): ?>
		...
		<a href="<?=$this->Html->url('/deplacements/categories/').$post['Stockcategorie']['id']?>" class="mega-link btn widthcent2"><font class="widthcent3"><?php echo $post['Stockcategorie']['nom'];?></font></a>
		</li>
