...
<tr><td><?php echo $this->Form->input('taillelot',array('label' => 'Taille du lot')); ?></td> <td><?php echo $this->Form->input('sec',array('label' => 'Stock de Sécurité','value'=>'0')); ?></td></tr>
<tr><td><?php echo $this->Form->input('poids',array('label' => 'Poids')); ?></td> <td><?php echo $this->Form->input('volume',array('label' => 'Volume')); ?></td></tr>
<tr><td><?php echo $this->Form->input('prix',array('label' => 'Prix d\'achat','value'=>'0')); ?></td> <td><?php echo $this->Form->input('prixv',array('label' => 'Prix de vente','value'=>'0'));  ?></td></tr>
