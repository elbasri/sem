...
<?php } ?> 
		...
		<tr>
		<td><?php echo $this->Form->input('rmethode',array('label'=>'Méthode de recherche','options'=>array(1=>'Libellé de Localisation',2=>'Espace de Localisation',3=>'ID d\'étage',4=>'ID de porte',5=>'Immeuble'),'style'=>'width: 100%')); ?></td>
...
<?php } ?>  
	...
	<td><?php 
	echo $this->HTML->link('Edit',array('controller'=>'pieces','action'=>'Edit',$post['Piece']['id'])).' '.$this->Form->postLink('Delete',array('controller'=>'pieces','action'=>'Delete',$post['Piece']['id']));?></td>
	</tr>
