...
<?php } ?> 
		<?php echo $this->Form->create('Projet',array('action'=>'recherche'));?>
		<table style="width:100%">
		<tr>
		<td><input name="rechercher" value="4" required="" type="radio"></td>
		<td style="text-align:left;">Recherche par référence du projet</td>
		</tr>
		
		<tr><td></td><td></td>
		<td><?php echo $this->Form->input('serie',array('label'=>'Recherche Par Numéro')); ?></td>
		<td><br><?php echo $this->Form->end('Lancer un recherche');?></td>
		</tr>
		
		<tr>
		<td><input name="rechercher" value="1" required="" type="radio"></td>
		<td style="text-align:left;">Recherche par Coûts de projet</td>
		</tr>
		
		<tr>
		<td></td><td></td>
		<td><?php echo $this->Form->input('cout1',array('label'=>'Entre')); ?></td>
		<td><?php echo $this->Form->input('cout2',array('label'=>'Et')); ?></td>
		</tr>
		
		<tr>
		<td><input name="rechercher" value="2" required="" type="radio"></td>
		<td style="text-align:left;">Recherche par Date de debut de projet</td>
		</tr>
		...
		<td style="text-align:left;">Recherche par Numéro de projet</td>
		</tr>
...
<div class="affichage" style="float:right;width:80%"> 
<?php } ?> 
	<h1>Resultat de recherche dans les Projets :</h1>
	<table >
	<tr>
	<th>Numéro</th>
	<th>Libellé</th>
	...
	<td><?php echo $post['Projet']['but'];?></td>
	<td><?php echo $post['Projet']['cout'];?></td>
	...
	<td><?php 
	echo $this->HTML->link('Modifier',array('controller'=>'projets','action'=>'modifier',$post['Projet']['id'])).' '.$this->Form->postLink('Supprimer',array('controller'=>'projets','action'=>'supprimer',$post['Projet']['id']));?></td>
	</tr>
