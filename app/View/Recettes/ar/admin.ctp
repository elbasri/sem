...
<table>
	...
	<tr>
		...
		<td><?php echo "Nombre: ".$counta."<br>TVA: ".$tvaa." ".$config['Configuration']['Devises']."<br>HT: ".$hta." ".$config['Configuration']['Devises']."<br>TTC: ".$ttca." ".$config['Configuration']['Devises'];?></td>
		<td><?php echo "Nombre: ".$countp."<br>TVA: ".$tvap." ".$config['Configuration']['Devises']."<br>HT: ".$htp." ".$config['Configuration']['Devises']."<br>TTC: ".$ttcp." ".$config['Configuration']['Devises'];?></td>
		<td><?php echo "Nombre: ".$counts."<br>TVA: ".$tvas." ".$config['Configuration']['Devises']."<br>HT: ".$hts." ".$config['Configuration']['Devises']."<br>TTC: ".$ttcs." ".$config['Configuration']['Devises'];?></td>
...
<div  align="center" class="menufooter">
 ...
 <div  align="center" class="menufooter">
	...
	<ul class="mega-container mega-grey" >
		<li class="mega mega-current widthcent4" >
		<a href="<?=$this->Html->url('/recettes/add')?>" class="mega-link btn widthcent2"><?php echo $this->Html->image('icons/add.png', array('alt' => 'votrecodeur.com icons','title'=>'votrecodeur.com icons'));?><font class="widthcent3">Ajouter</font></a>
		</li>
		<li class="mega mega-current widthcent4" >
		<a href="<?=$this->Html->url('/recettes/recherche')?>" class="mega-link btn widthcent2"><?php echo $this->Html->image('icons/folder_explore.png', array('alt' => 'votrecodeur.com icons','title'=>'votrecodeur.com icons'));?><font class="widthcent3">Rechercher</font></a>
		</li>
		<li class="mega mega-current widthcent4" >
		<a href="<?=$this->Html->url('/recettes/triasc')?>" class="mega-link btn widthcent2"><?php echo $this->Html->image('icons/arrow_turn_right.png', array('alt' => 'votrecodeur.com icons','title'=>'votrecodeur.com icons'));?><font class="widthcent3">Tri croissant</font></a>
		</li>
		<li class="mega mega-current widthcent4" >
		<a href="<?=$this->Html->url('/recettes/tridesc')?>" class="mega-link btn widthcent2"><?php echo $this->Html->image('icons/arrow_turn_left.png', array('alt' => 'votrecodeur.com icons','title'=>'votrecodeur.com icons'));?><font class="widthcent3">Tri décroissant</font></a>
		</li>
		<li class="mega mega-current widthcent4" >
		<a href="<?=$this->Html->url('/recettes/imprimerliste')?>" target="_blank"  class="mega-link btn widthcent2"><?php echo $this->Html->image('icons/printer_empty.png', array('alt' => 'votrecodeur.com icons','title'=>'votrecodeur.com icons'));?><font class="widthcent3">Imprimer</font></a>
		</li>
		<li class="mega mega-current widthcent4" >
		<a href="<?=$this->Html->url('/recettes/imprimerliste/pdf')?>" target="_blank"  class="mega-link btn widthcent2"><?php echo $this->Html->image('icons/page_white_acrobat.png', array('alt' => 'votrecodeur.com icons','title'=>'votrecodeur.com icons'));?><font class="widthcent3">Exporter</font></a>
		</li>
	</ul>
	</div>
</div>
