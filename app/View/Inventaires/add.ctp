...
<table>
<tr><td><?php echo $this->Form->input('nom_id',array('label' => 'Désignation','options' => $optionsdes,'style'=>'width: 100%','default'=>61)); ?></td>
<td><?php echo $this->Form->input('piece_id', array('label'=>'Emplacement','options' => $optionsemp,'style'=>'width: 100%','default'=>61)); ?></td>
</tr>

<tr>
<td><?php echo $this->Form->input('qte',array('label' => 'Quantité','value'=>'1')); ?></td>
