...
<?php } ?>  
		...
		<td style="text-align:left;">Recherche par Date de debut de congés</td>
		</tr>
		...
		<td style="text-align:left;">Recherche par Numéro de congés</td>
		</tr>
...
<div class="affichage" style="float:right;width:80%"> 
<?php } ?> 
	<h1>Resultat de recherche dans les congéss :</h1>
	<table >
	<tr>
	<th>Numéro</th>
