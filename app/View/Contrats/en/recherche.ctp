...
<?php } ?>
		<?php echo $this->Form->create('Contrat',array('action'=>'recherche'));?>
		<table style="width:100%">
		<tr>
		<td><input name="rechercher" value="2" required="" type="radio"></td>
		<td style="text-align:left;">Recherche par End date de contrat</td>
		</tr>
		...
		<td style="text-align:left;">Recherche par ID de contrat</td>
		</tr>
...
<div class="affichage" style="float:right;width:80%"> 
<?php } ?>
	<h1>Resultat de recherche dans les contrats :</h1>
	<table >
	<tr>
<th>ID</th>
<th>Libellé</th>
