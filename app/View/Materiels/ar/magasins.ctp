...
<?php foreach($options as $post): ?>
		...
		<a href="<?=$this->Html->url('/materiels/categories/').$post['Piece']['id']."/".$post['Piece']['nom']?>" class="mega-link btn widthcent2"><font class="widthcent3"><?php echo $post['Piece']['nom'];?></font></a>
		</li>
