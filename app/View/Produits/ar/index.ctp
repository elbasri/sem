...
<td>
<?php 
echo $this->HTML->link('Modifier',array('controller'=>'produits','action'=>'modifier',$post['Produit']['id'])).' '.$this->Form->postLink('Supprimer',array('controller'=>'produits','action'=>'supprimer',$post['Produit']['id']));
...
<div  align="center" class="menufooter">
	...
	<ul class="mega-container mega-grey" >
		...
		<a href="<?=$this->Html->url('/produits/add')?>" class="mega-link btn widthcent2"><font class="widthcent3">Ajouter</font></a>
		</li>
		<li class="mega mega-current widthcent4" >
		<a href="<?=$this->Html->url('/produits/recherche')?>" class="mega-link btn widthcent2"><font class="widthcent3">Rechercher</font></a>
		</li>
		<li class="mega mega-current widthcent4" >
		<a href="<?=$this->Html->url('/produits/triasc')?>" class="mega-link btn widthcent2"><font class="widthcent3">Tri croissant</font></a>
		</li>
		<li class="mega mega-current widthcent4" >
		<a href="<?=$this->Html->url('/produits/tridesc')?>" class="mega-link btn widthcent2"><font class="widthcent3">Tri décroissant</font></a>
		</li>
	</ul>
	</div>
</div>
