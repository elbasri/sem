...
<?php } ?> 
		...
		<td style="text-align:left;">Recherche par Reference du projet</td>
		</tr>
		
		<tr><td></td><td></td>
		<td><?php echo $this->Form->input('serie',array('label'=>'Recherche Par ID')); ?></td>
		...
		<td style="text-align:left;">Recherche par Start date de projet</td>
		</tr>
		...
		<td style="text-align:left;">Recherche par ID de projet</td>
		</tr>
...
<?php } ?> 
	...
	<td><?php 
	echo $this->HTML->link('Edit',array('controller'=>'projets','action'=>'Edit',$post['Projet']['id'])).' '.$this->Form->postLink('Delete',array('controller'=>'projets','action'=>'Delete',$post['Projet']['id']));?></td>
	</tr>
