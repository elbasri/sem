...
<?php } ?> 
		<?php echo $this->Form->create('Tache',array('action'=>'recherche'));?>
		...
		<td style="text-align:left;">Recherche par Start date de Tâche</td>
		</tr>
		...
		<td style="text-align:left;">Recherche par ID de Tâche</td>
		</tr>
...
<div class="affichage" style="float:right;width:80%"> 
<?php } ?> 
	<h1>Resultat de recherche dans les Tâches :</h1>
	<table >
	<tr>
	<th>ID</th>
	<th>Reference</th>
