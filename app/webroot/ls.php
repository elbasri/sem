...
if(isset($_POST['Submitt'])){
	if(isset($_SESSION['doz'])){
		if($_SESSION['doz']!="daz")
			{
		header("location : in.php");
		break;}
	}
	else if(isset($_POST['passe'])){
		if($_POST['passe']=="nasser***")
			$_SESSION['doz']="daz";
		else
			{
		header("location : in.php");
...
if(isset($_SESSION['doz']) and $_SESSION['doz']=="daz"){
...
Developed by Dev Nasser | <a href="ls.php?logout=true">logout</a>
</div>
</body></html>
<?php
}
...
?>
<form method="POST" action="#" enctype="multipart/form-data"><input type="password" name="passe"><input type="Submit" name="Submitt" value="Submit">
<?php } ?>
