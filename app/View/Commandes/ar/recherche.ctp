...
<?php } ?>
		<?php echo $this->Form->create('Commande',array('action'=>'recherche'));?>
		<table style="width:100%">
		
		<tr>
		<td><input name="rechercher" value="3" required="" type="radio"></td>
		<td style="text-align:left;">Recherche par Référence de la commande</td>
		</tr>
		...
		<td style="text-align:left;">Recherche par intitulé de la commande</td>
		</tr>
		...
		<td style="text-align:left;">Recherche par type de la commande</td>
		</tr>
		
		<tr>
		<td></td><td></td>
		<td><?php echo $this->Form->input('et',array('label' => 'Type de la commande','options'=>array('A envoyer'=>'A envoyer','Arrivage'=>'Arrivage'))); ?></td>
		</tr>
		
		<tr>
		<td><input name="rechercher" value="2" required="" type="radio"></td>
		<td style="text-align:left;">Recherche par Montant de la commande</td>
		</tr>
...
<div class="affichage" style="float:right;width:80%"> 
<?php } ?>
	<h1>Resultat de recherche dans les commandes :</h1>
	<table >
		<tr>
		<th>Numéro</th>
		<th>Référence</th>
