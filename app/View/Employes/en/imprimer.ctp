	...
	<div class="infosdemande" >
			...
			<?php if(!empty($user['Employe']['img'])){?>
				<tr >
					...
					<td style="width:5%"></td>
					<td style="width:35%">Name: <strong><?php echo $user['Employe']['nom'];?></strong>
				...
				<?php }else{?>
				<tr >
					<td style="width:5%"><?php echo $this->Html->image('images/nomdemande.png', array('alt' => '','title'=>'Add un employe')); ?>
					</td>
					<td style="width:35%">Name: <strong><?php echo $user['Employe']['nom'];?></strong>
					</td>
					
					<td style="width:5%"><?php echo $this->Html->image('images/nomdemande.png', array('alt' => '','title'=>'Add un employe'));?></td>
					<td style="width:35%">Prénom: <strong><?php echo $user['Employe']['prenom'];?></strong>
					</td>
					
				</tr>
				<tr >
					<td><?php echo $this->Html->image('images/nomdemande.png', array('alt' => '','title'=>'Add un employe')); ?>
					</td>
					<td>CIN: <strong><?php echo $user['Employe']['cin'];?></strong>
					</td>
					
					<td><?php echo $this->Html->image('images/nomdemande.png', array('alt' => '','title'=>'Add un employe'));?></td>
				...
				<tr>
					...
					<td>Civility: <strong><?php echo $user['Employe']['civilite'];?></strong>
					</td>
					
					<td><?php echo $this->Html->image('images/telephonedemande.png', array('alt' => '','title'=>'Add un employe'));?></td>
					<td>Phone: <strong><?php echo $user['Employe']['tel'];?></strong>
					</td>
				</tr>
				<tr>
				
					<td><?php echo $this->Html->image('images/emaildemande.png', array('alt' => '','title'=>'Add un employe'));?></td>
					<td>Le Pays/Nationalité: <strong><?php echo $user['Employe']['pays'];?></strong>
					</td>
					
					<td><?php echo $this->Html->image('images/emaildemande.png', array('alt' => '','title'=>'Add un employe'));?></td>
					<td>City: <strong><?php echo $user['Employe']['ville'];?></strong>
					</td>
				</tr>
				<tr>
					<td><?php echo $this->Html->image('images/emaildemande.png', array('alt' => '','title'=>'Add un employe'));?></td>
					<td>Postcode: <strong><?php echo $user['Employe']['codep'];?></strong>
					</td>
					<td><?php echo $this->Html->image('images/emaildemande.png', array('alt' => '','title'=>'Add un employe'));?></td>
				...
				<tr>
					<td><?php echo $this->Html->image('images/secietedemande.png', array('alt' => '','title'=>'Add un employe'));?></td>
					<td>Start date du contrat: <strong><?php echo $user['Employe']['datetravail'];?></strong>
					</td>
					<td><?php echo $this->Html->image('images/nomdemande.png', array('alt' => '','title'=>'Add un employe'));?></td>
					<td>End date du contrat: <strong><?php echo $user['Employe']['datefintravail']; if(date('Y-m-d')>$user['Employe']['datefintravail']) echo "<br><font color='red'>Contrat expiré</font>";?></strong>
					</td>
				</tr>
				<tr>
					<td><?php echo $this->Html->image('images/secietedemande.png', array('alt' => '','title'=>'Add un employe'));?></td>
				...
				<tr>
					...
					<td><strong><a href="<?php echo $user['Employe']['contrat'];?>">Cliquer ici pour Phoneécharger le contrat</a></strong>
					</td>
					<td></td>
					<td>
					</td>
