...
<td width="300">{Votre mot de passe que vous avez entré}</td>
<td><strong>
<?php 
echo $this->Html->link('Modifier profile',array('controller'=>'users','action'=>'edit',$user['User']['id']));
?></strong>
</td>
</tr>
</table>
		...
		<div class="infosdemande" >
			...
			<table >	
				...
				<tr >
					...
					<td width="350">Civilité: <strong><?php echo $user['User']['civilite'];?></strong>
					</td>
					
					<td width="50"><?php echo $this->Html->image('images/nomdemande.png', array('alt' => 'Créer un compte sur votrecodeur.com','title'=>'Créer un compte sur votrecodeur.com')); ?>
					</td>
					<td width="350">Nom: <strong><?php echo $user['User']['nom'];?></strong>
					</td>
				...
				<tr>
					...
					<td>Téléphone: <strong><?php echo $user['User']['tel'];?></strong>
					</td>
				</tr>
				<tr>
					...
					<td>societé: <strong><?php echo $user['User']['societe'];?></strong>
					</td>
					
					<td><?php echo $this->Html->image('images/secietedemande.png', array('alt' => 'Créer un compte sur votrecodeur.com','title'=>'Créer un compte sur votrecodeur.com'));?></td>
					<td>Pays: <strong><?php echo $user['User']['pays'];?></strong>
				</tr>
				<tr>
					<td><?php echo $this->Html->image('images/secietedemande.png', array('alt' => 'Créer un compte sur votrecodeur.com','title'=>'Créer un compte sur votrecodeur.com'));?></td>
					<td>Ville: <strong><?php echo $user['User']['ville'];?></strong>
					</td>
					<td><?php echo $this->Html->image('images/secietedemande.png', array('alt' => 'Créer un compte sur votrecodeur.com','title'=>'Créer un compte sur votrecodeur.com'));?></td>
					<td>code postale: <strong><?php echo $user['User']['codep'];?></strong>
					</td>
