...
<head>
	...
	<link rel="stylesheet" href="<? $domain.$this->Html->url('/css')?>/jquery.bxslider.css" type="text/css" />
	<link rel="stylesheet" href="<? $domain.$this->Html->url('/css')?>/styles.css" type="text/css" /> 
