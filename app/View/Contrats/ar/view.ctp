...
?>
	...
	<div class="infosdemande" >
			...
			<table>
				<tr >
					<td style="width:35%">Référence: <strong><?php echo $post['Contrat']['reference'];?></strong>
					</td>
				...
				<tr >
					<td style="width:35%">Date de début: <strong><?php echo $post['Contrat']['dated'];?></strong>
					</td>
					
					<td style="width:35%">Date de fin: <strong><?php echo $post['Contrat']['datef'];?></strong>
					</td>
				</tr>
				<tr >
					<td style="width:35%">État actuel: <strong><?php if(date('Y-m-d')>$post['Contrat']['datef']) echo "<font color='red'>Contrat expiré</font>"; else echo "<font color='green'>Contrat valide</font>";?></strong>
					</td>
