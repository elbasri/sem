...
<?php } ?>
<!--<h1>Les pages statique. <?php echo $this->Html->link('Add une page',array('controller'=>'consultations','action'=>'add')); ?></h1>-->
<table>
<tr>
<th>ID</th><th>Titre</th><th>Etat</th><th>Slide d'accueil</th><th>Date de création</th><th>Action</th>
</tr>
<?php 
$count=0; $p=0; $b=0;
...
<td><?php echo $this->Html->link('Edit',array('action'=>'edit',$post['Consultation']['id'],Inflector::slug($post['Consultation']['titre'],$replacement ='_'))).' '.$this->Form->postLink('Delete',array('action'=>'delete',$post['Consultation']['id']),array('confirm'=>'Vous etes sur ?'));?></td>
</tr>
<?php endforeach;?>
<?php unset($post);?>
...
<div  align="center" class="menufooter">
	...
	<ul class="mega-container mega-grey" >
		...
		<a href="<?=$this->Html->url('/consultations/add')?>" class="mega-link btn widthcent2"><font class="widthcent3">Add</font></a>
		</li>
		<li class="mega mega-current widthcent4" >
		<a href="<?=$this->Html->url('/consultations/recherche')?>" class="mega-link btn widthcent2"><font class="widthcent3">Search</font></a>
		</li>
		<li class="mega mega-current widthcent4" >
		<a href="<?=$this->Html->url('/consultations/triasc')?>" class="mega-link btn widthcent2"><font class="widthcent3">Sort ascendant</font></a>
		</li>
		<li class="mega mega-current widthcent4" >
		<a href="<?=$this->Html->url('/consultations/tridesc')?>" class="mega-link btn widthcent2"><font class="widthcent3">Sort descending</font></a>
		</li>
	</ul>
	</div>
</div>
