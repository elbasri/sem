...
<?php } ?> 
	...
	<td><?php 
	echo $this->HTML->link('Edit',array('controller'=>'stockcategories','action'=>'Edit',$post['Stockcategorie']['id'])).' '.$this->Form->postLink('Delete',array('controller'=>'stockcategories','action'=>'Delete',$post['Stockcategorie']['id']));?></td>
	</tr>
