...
echo $this->Form->input('devis',array('label' => 'Détails du devis','value'=>$devis));
echo $this->Form->input('montant',array('label' => 'Montant TTC','value'=>'0'));

echo "</div><table>";

echo "<tr><td>".$this->Form->input('type',array('label' => 'Type','options'=>array('Devis'=>'Devis','Devis estimatif'=>'Devis estimatif')))."</td><td>";
echo $this->Form->input('tva2',array('label' => 'TVA2 %','value'=>'0'))."</td></tr><tr><td>";
echo $this->Form->input('frais',array('label' => 'Frais de dossier','value'=>'0'))."</td><td>";
echo $this->Form->input('remise',array('label' => 'Remise %','value'=>'0'))."</td></tr><tr><td>";
