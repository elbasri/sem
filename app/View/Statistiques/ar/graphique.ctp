...
<div  align="center" class="menufooter">
	...
	<ul class="mega-container mega-grey" >
		...
		<li class="mega mega-current widthcent4" >
		<a href="<?=$this->Html->url('/')?>statistiques/imprimergraphique/" class="mega-link btn widthcent2"><?php echo $this->Html->image('icons/printer.png');?><font class="widthcent3">imprimer le Graph</font></a>
		</li>
	</ul>
	</div>
</div>
