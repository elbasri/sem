...
<?php echo $this->Form->create('User');?>
		...
		<div class="infosdemande" >
			...
			<table >	
				...
				<tr >
					<td><?php echo $this->Html->image('icons/username.png', array('alt' => 'your username','title'=>'Le pseudo')); ?>
					</td>
					<td><?php echo $this->Form->input('username',array('label'=>'Le pseudo'));?>
					</td>
					
					<td><?php echo $this->Html->image('icons/password.png', array('alt' => 'your password','title'=>'Le mot de passe')); ?>
					</td>
				...
				<tr>
					...
					<td><?php echo $this->Form->input('societe',array('id'=>'company_name','placeholder'=>'La Company'));
					?>
					</td>
				...
				if($this->Session->read('Auth.User.role')=='admin')
					...
					echo $this->Form->input('role',array('label'=>'The type of user','options'=>array('client'=>'Client')));
				?>
				</td>
				<td></td>
				<td></td>
		...
		<h2>Droits</h2>
			<table>
				<tr>
					<td ><?php echo $this->Form->input('add',array('label' => 'Add &nbsp; &nbsp; &nbsp; &nbsp;','type'=>'checkbox',));?>
					</td>
					<td><?php echo $this->Form->input('delete',array('label' => 'Delete','type'=>'checkbox'));?>
					</td>
					<td><?php echo $this->Form->input('edit',array('label' => 'Edit','type'=>'checkbox'));?>
					</td>
				</tr>
				<tr>
					<td><?php echo $this->Form->input('recherche',array('label' => 'Search','type'=>'checkbox'));?>
					</td>
					<td><?php echo $this->Form->input('imprimer',array('label' => 'Print and export folders','type'=>'checkbox'));?>
					</td>
					<td><?php echo $this->Form->input('imprimerliste',array('label' => 'Print and export lists','type'=>'checkbox'));?>
					</td>
				</tr>
			</table>
