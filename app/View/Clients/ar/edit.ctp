...
?>	</h1>		
			<table >	
				...
				<tr >
					...
					<td><?php echo $this->Form->input('ref',array('id'=>'nom','placeholder'=>'Référence'));?>
					</td>
				...
				<tr >
					...
					<td><?php echo $this->Form->input('nom',array('id'=>'nom','placeholder'=>'Nom de Societé','label'=>'Nom de l\'établissement'));?>
					</td>
