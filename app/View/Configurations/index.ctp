...
<h2 style="margin:10px 10px 10px 10px;"  onclick="confaffichage('confinfos');">Informations La délégation</h2>
		<div class="infosdemande" id="confinfos" style="display:none">
			<table>	
				<tr>
					<td><?php echo $this->Form->input('logo',array('label'=>'Logo','id'=>'SliderPhoto'));?><h3>&nbsp;<a href="#" style="text-align:center"  onclick="openFileBrowserSliderPhoto(); return false;" >Selectionner</a></h3>
					</td>
					<td><?php echo $this->Form->input('header',array('label'=>'L\'entête','id'=>'SliderPhoto1'));?><h3>&nbsp;<a href="#" style="text-align:center"  onclick="openFileBrowserSliderPhoto1(); return false;" >Selectionner</a></h3>
					</td>
				</tr>
				<tr>
					<td><?php echo $this->Form->input('titre',array('label'=>'Nom La délégation en français'));?>
					<?php echo $this->Form->input('titreen',array('label'=>'Nom La délégation en anglais'));?>
					<?php echo $this->Form->input('titrear',array('label'=>'Nom La délégation en arabe'));?>
					</td>
