...
<?php } ?>  
		<?php echo $this->Form->create('Saisir',array('action'=>'recherche'));?>
		<table style="width:100%">
		<tr>
		<td><input name="rechercher" value="2" required="" type="radio"></td>
		<td style="text-align:left;">Recherche par Date de Saisie</td>
		</tr>
		...
		<td style="text-align:left;">Recherche par Reference de Saisie</td>
		</tr>
		...
		<td style="text-align:left;">Recherche par ID de Saisie</td>
		</tr>
...
<div class="affichage" style="float:right;width:80%"> 
<?php } ?> 
	<h1>Resultat de recherche dans les Saisies :</h1>
	<table >
	<tr>
	<th>ID</th>
	<th>Reference</th>
