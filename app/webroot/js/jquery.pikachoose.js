...
(function ($) {
    ...
    $pc.fn.extend({
        ...
        bindEvents: function () {
            ...
            this.imgPlay.unbind('click').bind('click', {
                self: this
            }, this.playClick);
            this.wrap.unbind('mouseenter').bind('mouseenter', {
                self: this
            }, function (e) {
            ...
            this.tooltip.unbind('mouseenter').bind('mouseenter', {
                self: this
            }, function (e) {
                clearTimeout(e.data.self.stillOut)
            });
            this.tooltip.unbind('mouseleave').bind('mouseleave', {
                self: this
            }, function (e) {
