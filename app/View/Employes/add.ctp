		...
		<div class="infosdemande" >
			...
			<table >	
				...
				<tr>
					...
					<td><?php echo $this->Html->image('images/secietedemande.png', array('alt' => '','title'=>''));?></td>
					<td><?php echo $this->Form->input('salaire',array('id'=>'salaire','placeholder'=>'Le salaire de l\'employe','label'=>'Le salaire','value'=>'0'));
					?>
					</td>
				</tr>
				<tr>
...
<?php echo $this->Form->end('Déclarer l\'employe'); ?>
					</td>
				</tr>
	</table>	
</div>