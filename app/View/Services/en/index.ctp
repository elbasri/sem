...
<td>
<?php 
echo $this->HTML->link('Edit',array('controller'=>'Services','action'=>'Edit',$post['Service']['id'])).' '.$this->Form->postLink('Delete',array('controller'=>'services','action'=>'Delete',$post['Service']['id']));
...
echo $this->Paginator->counter('Page {:page} of {:pages} Pages');
 ...
 <div  align="center" class="menufooter">
	...
	<ul class="mega-container mega-grey" >
		...
		<a href="<?=$this->Html->url('/services/add')?>" class="mega-link btn widthcent2"><font class="widthcent3">Add</font></a>
		</li>
		<li class="mega mega-current widthcent4" >
		<a href="<?=$this->Html->url('/services/recherche')?>" class="mega-link btn widthcent2"><font class="widthcent3">Search</font></a>
		</li>
		<li class="mega mega-current widthcent4" >
		<a href="<?=$this->Html->url('/services/triasc')?>" class="mega-link btn widthcent2"><font class="widthcent3">Sort ascendant</font></a>
		</li>
		<li class="mega mega-current widthcent4" >
		<a href="<?=$this->Html->url('/services/tridesc')?>" class="mega-link btn widthcent2"><font class="widthcent3">Sort descending</font></a>
		</li>
	</ul>
	</div>
</div>
