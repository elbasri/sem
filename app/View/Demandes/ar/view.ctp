		...
		<div class="infosdemande" >
			...
			<table >	
				...
				<tr >
					...
					<td width="350">Nom: <strong><?php echo $post['Demande']['nom'];?></strong>
					</td>
				...
				<tr>
					...
					<td>Societé: <strong><?php echo $post['Demande']['societe'];?></strong>
					</td>
					...
					<td>Téléphone: <strong><?php echo $post['Demande']['tel'];?></strong>
					</td>
				</tr>
