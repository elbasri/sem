	...
	<div class="infosdemande" >
			...
			<table >
				<tr >
					...
					<td style="width:35%">Référence: <strong><?php echo $post['Projet']['ref'];?></strong>
					</td>
				</tr>
				<tr >
				...
				<tr >
					<td style="width:35%">Date de debut: <strong><?php echo $post['Projet']['dated'];?></strong>
					</td>
					<td style="width:35%">Date de fin: <strong><?php echo $post['Projet']['datef'];?></strong>
					</td>
				</tr>
				<tr >
					<td style="width:35%">État actuel: <strong><?php if(date('Y-m-d')>$post['Projet']['datef']) echo "<font color='red'>Projet Terminé</font>"; else if(date('Y-m-d')<$post['Projet']['datef'] && date('Y-m-d')>$post['Projet']['dated'])echo "<font color='green'>Projet encours</font>"; else if (date('Y-m-d')<$post['Projet']['dated'])echo "<font color='blue'>Projet à venir</font>";?></strong>
					</td>
